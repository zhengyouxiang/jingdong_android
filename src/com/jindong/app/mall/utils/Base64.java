...
_L5:
        ...
        throws IOException
    {
        ...
        byte abyte5[] = s.getBytes("US-ASCII");
        byte abyte0[] = abyte5;
_L3:
        byte abyte1[];
        byte abyte2[];
        ...
        j = 0;
_L4:
        j = gzipinputstream.read(abyte3);
        if(j >= 0) goto _L2; else goto _L1
_L1:
        abyte4 = bytearrayoutputstream1.toByteArray();
        abyte2 = abyte4;
...
_L9:
        ...
        abyte0 = s.getBytes();
          goto _L3
_L2:
        bytearrayoutputstream1.write(abyte3, 0, j);
          goto _L4
        ioexception;
        k = j;
        bytearrayinputstream = bytearrayinputstream1;
...
label0:
            {
                ...
                if(byte1 >= -5)
                {
                    ...
                    l1 = l + decode4to3(abyte3, 0, abyte2, l, k);
                    k1 = 0;
                    if(abyte0[i1] != 61)
                        break label0;
                    i2 = l1;
...
_L2:
        objectinputstream = new ObjectInputStream(classloader) {
                ...
                throws IOException, ClassNotFoundException
            {
                ...
                Class class2;
                if(class1 == null)
                    class2 = super.resolveClass(objectstreamclass);
                else
                    class2 = class1;
                return class2;
            }
...
_L2:
    ...
    static 
    {
        ...
        byte abyte4[];
        byte abyte5[];
        if(!com/jindong/app/mall/utils/Base64.desiredAssertionStatus())
            flag = true;
        else
            flag = false;
